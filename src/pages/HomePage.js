...
function HomePage(){
    return(
        <>
          <Helmet>
            <title>Двери тут Сморгонь – Качественные двери по доступным ценам.</title>
            ...
            <meta name="keywords" content="двери,двери тут, двери Сморгонь, входные двери, межкомнатные двери, купить двери, установка дверей, Сморгонь" />
