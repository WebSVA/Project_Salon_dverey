    ...
    return(
        ...
        <div className="PrefContainer">
            <PreferencesCard 
                ...
                description="Наша команда опытных специалистов обеспечит вам быстрый замер дверных проёмов, качественный монтаж входных и межкомнатных дверей, арок, порталов и раздвижных систем. Все работы осуществляется квалифицированными специалистами с большим опытом." 
            />
            <PreferencesCard
